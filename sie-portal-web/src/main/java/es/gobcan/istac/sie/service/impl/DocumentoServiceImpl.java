...
public class DocumentoServiceImpl implements DocumentoService {
    ...
    public byte[] generarPdfEvolucionElectoral(EvolucionElectoralDTO evolucionElectoral, byte[] grafica) {
        ...
        String rutaSubinforme = getClass().getResource(Constants.CARPETA_JASPER_REPORT + EVOLUCION_ELECTORAL_SUBINFORME_TEMPLATE).getPath();
        parametros.put("rutaSubinforme", rutaSubinforme);
